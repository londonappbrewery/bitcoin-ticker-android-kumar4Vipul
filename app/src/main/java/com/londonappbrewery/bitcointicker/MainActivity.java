...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPriceTextView = (TextView) findViewById(R.id.last);
        mBidTextView = (TextView) findViewById(R.id.bid);
        ...
        Client.get(url, new JsonHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject responseBody) {
                ...
                try {
                    ...
                    String bid = responseBody.getString("bid");
            ...
            @Override
            public void onFailure(int statusCode, Header[] headers, Throwable e ,JSONObject responseBody) {
                Log.d("Bitcoin","Request Fail");
            }
        });
